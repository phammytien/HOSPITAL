                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                @for($i = 1; $i <= 5; $i++)
                                    <i class="fas fa-star {{ $i <= ($feedback->rating ?? 0) ? 'text-yellow-400' : 'text-gray-300' }}"></i>
                                @endfor
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-gray-600">{{ $feedback->created_at ? $feedback->created_at->format('d/m/Y H:i') : 'N/A' }}</p>
                        </td>
                        <td class="px-6 py-4">
