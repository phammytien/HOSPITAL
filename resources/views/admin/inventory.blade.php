...
<div class="space-y-6">
    ...
    <!-- Filters and Search -->
    <form method="GET" action="{{ route('admin.inventory') }}" id="filterForm" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Phòng ban</label>
                <select name="department_id" id="departmentFilter" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div>
                ...
                <select name="warehouse_id" id="warehouseFilter" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <option value="{{ $warehouse->id }}" {{ request('warehouse_id') == $warehouse->id ? 'selected' : '' }}>
                        {{ $warehouse->warehouse_name }} ({{ $warehouse->department->department_name ?? 'N/A' }})
                    </option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="mt-4 flex justify-end space-x-2">
            @if(request('search') || request('department_id') || request('warehouse_id') || request('category_id'))
            <a href="{{ route('admin.inventory') }}" class="border border-gray-300 bg-white hover:bg-gray-50 text-gray-600 px-4 py-2 rounded-lg">
