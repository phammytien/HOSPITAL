    ...
    <form method="GET" action="{{ route('admin.inventory') }}" id="filterForm" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" name="search" id="searchInput" value="{{ request('search') }}" placeholder="Tên sản phẩm, mã SKU..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <select name="department_id" id="departmentFilter" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Thông tin sản phẩm</th>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-gray-900 text-sm">{{ $item->warehouse->warehouse_name }}</p>
                        ...
                        <td class="px-6 py-4">
                            <span class="text-sm text-gray-700">{{ $item->warehouse->department->department_name ?? 'N/A' }}</span>
                        </td>
                        <td class="px-6 py-4">
