...
<body class="flex h-screen overflow-hidden">
    <!-- Left Side: Branding -->
    <div class="hidden md:flex flex-col justify-between w-1/2 p-12 text-white bg-gradient-to-br from-blue-600 to-blue-900"
    ...
    <div class="flex flex-col justify-center items-center w-full md:w-1/2 p-8 bg-white relative">
        <!-- Background Pattern -->
        <div class="absolute inset-0 bg-white opacity-50 z-0"
        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3 @error('email') border-red-500 @enderror"
                            placeholder="Ví dụ: example@tmmchealthcare.com" required value="{{ old('email') }}">
                    </div>
                    @error('email')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <div id="togglePassword"
                            ...
                            <!-- Eye Icon (Show) - Initially hidden if type is password? No, usually show Eye when hidden. -->
                            <!-- Let's start with Eye (Open) and Eye Slash (Closed). 
                                 Common UI: 
                                 Password Hidden (dots) -> Show Eye 
                                 Password Visible (text) -> Show Eye Slash 
                            -->
                            ...
                            <svg id="eyeSlashIcon" class="w-5 h-5 text-gray-400 hidden" fill="none"
                ...
                <div class="flex items-center justify-end">
                    <a href="{{ route('password.request') }}"
                        class="text-sm font-medium text-blue-600 hover:underline">Quên mật khẩu?</a>
                </div>

                <button type="submit"
                    class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center flex items-center justify-center">
                    Đăng nhập hệ thống
            ...
            <div class="mt-8 text-center text-xs text-gray-500">
                Gặp sự cố kỹ thuật? <a href="{{ route('support.contact') }}" class="text-blue-600 hover:underline">Liên
                    hệ bộ phận IT</a>
            </div>
        </div>
    </div>
