...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div class="flex border-b border-gray-200">
            ...
            <a href="{{ route('buyer.notifications.index', ['type' => 'info']) }}" 
            ...
            <a href="{{ route('buyer.notifications.index', ['type' => 'warning']) }}" 
            ...
            <a href="{{ route('buyer.notifications.index', ['type' => 'error']) }}" 
            ...
            <a href="{{ route('buyer.notifications.index', ['type' => 'success']) }}" 
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-4 text-xs {{ !$notification->is_read ? 'text-gray-600 font-medium' : 'text-gray-500' }}">
                            ...
                            <span class="flex items-center gap-1">
                                ...
                                Đối tượng nhận: {{ $notification->target_role === 'ADMIN' ? 'Admin' : 'Khoa/Phòng' }}
                            </span>
                            <span class="flex items-center gap-1">
...
function openNotificationModal(id, title, message, badge, color, isRead) {
    ...
    if (!isRead) {
        fetch(`{{ url('buyer/notifications') }}/${id}/read`, {
            method: 'POST',
            headers: {
