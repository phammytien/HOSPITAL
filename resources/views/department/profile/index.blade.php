...
@section('content')
    ...
    <div id="editInfoModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <form action="{{ route('department.profile.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="space-y-4">
    ...
    <div id="changePassModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden">
            ...
            <form action="{{ route('department.profile.password') }}" method="POST" autocomplete="off" class="p-8">
                @csrf
                <div class="space-y-5">
                    <div>
