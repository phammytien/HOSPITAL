...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="p-6">
                        <div class="flex gap-4">
                            <img src="https://via.placeholder.com/100" alt="{{ $item->product->product_name ?? 'N/A' }}" 
        ...
        <div class="space-y-6">
            <!-- Ngân sách -->
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-4">Ngân sách Q4</h3>
                
                <div class="mb-4">
                    <div class="flex justify-between text-sm mb-2">
                        <span class="text-gray-600">Tổng chi phí (Lũy kế)</span>
                        <span class="font-bold text-gray-900">{{ number_format($totalAmount, 0, ',', '.') }} VNĐ</span>
                    </div>
                    <div class="flex justify-between text-sm mb-2">
                        <span class="text-gray-600">Giá sau giảm ({{ number_format(($totalAmount * 0.15), 0, ',', '.') }})</span>
                        <span class="font-bold text-gray-900">{{ number_format($totalAmount * 0.85, 0, ',', '.') }} VNĐ</span>
                    </div>
                </div>
                
                <div class="pt-4 border-t border-gray-200">
                    <div class="flex justify-between items-center mb-4">
                        <span class="text-gray-900 font-semibold">Tổng chi phí (Lũy kế)</span>
                        <span class="text-2xl font-bold text-blue-600">{{ number_format($totalAmount, 0, ',', '.') }} VNĐ</span>
                    </div>
                    
                    <div class="mb-4">
                        <div class="flex justify-between text-sm mb-2">
                            <span class="text-gray-600">Số dư đặt hàng</span>
                            <span class="font-semibold text-gray-900">142</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Mức độ ưu tiên</span>
                            <span class="px-2 py-1 bg-red-100 text-red-600 rounded text-xs font-semibold">Cao</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-yellow-900 mb-2">Ghi chú cho bộ</h4>
                        <p class="text-sm text-yellow-800">
                            Thiết giải trình cho bộ phận kế toán về mục đích sử dụng khoản chi này để được phê duyệt.
                        </p>
                    </div>
                </div>
            </div>
